...
var fightOrSkip = function() {
    ...
    if (promptFight === "" || promptFight === null) {
        window.alert("You need to provide a vald answer! Please try again.");
...
var fight = function(enemy) {
    ...
    // repeat and execute as long as the enemy-roobt is alive
...
var endGame = function() {
    ...
    // if player has more money than the high score, playe has new high score!
...
var getPlayerName = function() {
    ...
    while (name === "" || name === null) {
        name = prompt("What is yout robot's name?");
    }
